...
def book_restaurant_table(request,restaurant, booking_date_time, people, minutes_slot=90):
    """
        ...
        if form.is_valid():
         #   document_item1 = form1.save(commit=False)
           ...
           # document_item1.save()
            document_item2.save()
            document_item3.save()
            return redirect('/Booking', messages.success(request, 'Booking was successfully created.', 'alert-success'))
